					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<form action="${root}/example/save" method="post" id="format_form" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">示例名称<span
											class="required">*</span>
										</label>

										<div class="controls">

											<input type="text" name="name" value="${example.name}" data-required="1"
												class="span6 m-wrap" />
