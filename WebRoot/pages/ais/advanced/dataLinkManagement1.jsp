...
<body>
	...
	<div class="right-wrap">
		<div class="right-container">
			...
			<div class="ui-title fn-clear">
				...
				<h2 class="ui-title-cnt fn-left">基站中用数据链接管理时隙分配</h2>
			</div>
			<div class="formtabs">
	          <ul>
	             <li class="formtabs-on" onclick="showCard(this,'formtabs2_cont','formtabs')">1-4</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">5-8</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">9-12</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">13-16</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">17-20</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">21-24</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">25-28</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">29-32</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">33-37</li>
	             <li class="formtabs-off" onclick="showCard(this,'formtabs2_cont','formtabs')">38-40</li>
	         </ul>
       		 </div>
			<!--标题栏结束-->
			<span class="x-line fn-clear">&nbsp;</span>

			<form name="form1" id="form-validateA" action="${root}/siteinfo/advanced/dlmForm/save" method="post">
				...
				<div class="ui-list fn-clear" id="formtabs2_cont0" >
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							<tr>
								...
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA1.startSlot==null?0:entityA1.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA2.startSlot==null?0:entityA2.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA3.startSlot==null?0:entityA3.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA4.startSlot==null?0:entityA4.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							<tr>	
								...
								<td><input type="text" name="increment" id="incrementA" value="${entityA1.increment==null?0:entityA1.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Increment</label>
								</th>
								<td><input type="text" name="increment" id="incrementA" value="${entityA2.increment==null?0:entityA2.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Increment</label>
								</th>
								<td><input type="text" name="increment" id="incrementA" value="${entityA3.increment==null?0:entityA3.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Increment</label>
								</th>
								<td><input type="text" name="increment" id="incrementA" value="${entityA4.increment==null?0:entityA4.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							<tr>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA1.slotNumber==null?0:entityA1.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA2.slotNumber==null?0:entityA2.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA3.slotNumber==null?0:entityA3.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA4.slotNumber==null?0:entityA4.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA1" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA1.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA1.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA1.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA2" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA2.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA2.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA2.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA3" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA3.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA3.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA3.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA4" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA4.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA4.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA4.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB1" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB1.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB1.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB1.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB2" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB2.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB2.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB2.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB3" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB3.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB3.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB3.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB4" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB4.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB4.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB4.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							<tr>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA5.startSlot==null?0:entityA5.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA6.startSlot==null?0:entityA6.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA7.startSlot==null?0:entityA7.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA" value="${entityA8.startSlot==null?0:entityA8.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							<tr>	
								...
								<td><input type="text" name="increment" id="incrementA" value="${entityA5.increment==null?0:entityA5.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Increment</label>
								</th>
								<td><input type="text" name="increment" id="incrementA" value="${entityA6.increment==null?0:entityA6.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Increment</label>
								</th>
								<td><input type="text" name="increment" id="incrementA" value="${entityA7.increment==null?0:entityA7.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Increment</label>
								</th>
								<td><input type="text" name="increment" id="incrementA" value="${entityA8.increment==null?0:entityA8.increment}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入步长!" class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							<tr>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA5.slotNumber==null?0:entityA5.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA6.slotNumber==null?0:entityA6.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA7.slotNumber==null?0:entityA7.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
								<th><label class="">Block Size</label></th>
								<td><input type="text" name="slotNumber" id="slotNumberA" value="${entityA8.slotNumber==null?0:entityA8.slotNumber}" style="width: 80px"
									datatype="*" sucmsg=" " nullmsg="请输入时隙数目!" class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA5" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA5.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA5.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA5.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA6" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA6.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA6.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA6.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA7" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA7.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA7.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA7.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA8" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA8.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA8.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA8.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB5" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB5.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB5.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB5.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB6" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB6.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB6.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB6.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB7" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB7.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB7.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB7.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB8" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB8.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB8.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB8.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
				...
				<div class="ui-list fn-clear" id="formtabs2_cont2" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA9" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA9.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA9.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA9.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA10" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA10.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA10.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA10.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA11" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA11.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA11.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA11.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA12" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA12.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA12.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA12.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB9" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB9.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB9.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB9.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB2" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB10.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB10.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB10.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB11" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB11.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB11.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB11.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB12" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB12.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB12.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB12.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','3')">保存</button>
				...
				<div class="ui-list fn-clear" id="formtabs2_cont3" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA13" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA13.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA13.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA13.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA14" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA14.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA14.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA14.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA15" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA15ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA15.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA15.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA16" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA16.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA16.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA16.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB13" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB13.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB13.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB13.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB14" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB14.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB14.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB14.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB15" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB15.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB15.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB15.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB16" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB16.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB16.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB16.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','4')">保存</button>
				...
				<div class="ui-list fn-clear" id="formtabs2_cont4" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA17" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA17.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA17.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA17.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA18" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA18.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA18.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA18.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA19" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA19.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA19.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA19.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA20" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA20.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA20.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA20.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB17" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB17.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB17.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB17.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB18" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB18.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB18.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB18.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB19" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB19.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB19.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB19.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB20" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB20.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB20.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB20.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','5')">保存</button>
			...
			<form name="form1" id="form-validateA" action="${root}/siteinfo/advanced/dlmForm/save" method="post">
				...
				<!-- 基站A保留1 -->
				<div class="ui-list fn-clear" id="formtabs2_cont5" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						<colgroup>
							<!--注意用colgrounp标签组定义表格的每列宽度不可删除-->
							<col></col>
						...
						<tbody>
							<tr>
								...
								<th><label class="">Start Slot</label></th>
								<td>
								<input type="text" name="startSlot" id="startSlotA23" value="${entityA24.startSlot==null?0:entityA24.startSlot}" style="width: 80px"
									datatype="/(^(-)1|0$)|(^[1-9]\d{0,2}$)|(^2[0-1]\d{2}$)|(^22[0-3]\d{1}$)|(^224[0-9]$)/" sucmsg=" " nullmsg="请输入启动时隙!" 
									class="input-normal input-wd20  fn-left" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA21" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA21.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA21.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA21.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA22" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA22.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA22.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA22.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA23" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA23.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA23.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA23.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA24" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA24.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA24.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA24.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB21" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB21.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB21.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB21.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB22" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB22.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB22.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB22.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB23" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB23.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB23.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB23.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB24" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB24.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB24.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB24.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','6')">保存</button>
			...
			<form name="form1" id="form-validateA" action="${root}/siteinfo/advanced/dlmForm/save" method="post">
				...
				<!-- 基站A保留1 -->
				<div class="ui-list fn-clear" id="formtabs2_cont6" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						<colgroup>
							<!--注意用colgrounp标签组定义表格的每列宽度不可删除-->
							<col></col>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA25" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA25.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA25.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA25.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA26" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA26.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA26.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA26.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA27" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA27.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA27.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA27.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA28" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA28.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA28.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA28.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB25" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB25.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB25.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB25.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB26" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB26.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB26.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB26.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB27" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB27.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB27.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB27.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB28" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB28.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB28.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB28.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','7')">保存</button>
			...
			<form name="form1" id="form-validateA" action="${root}/siteinfo/advanced/dlmForm/save" method="post">
				...
				<!-- 基站A保留1 -->
				<div class="ui-list fn-clear" id="formtabs2_cont7" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						<colgroup>
							<!--注意用colgrounp标签组定义表格的每列宽度不可删除-->
							<col></col>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA29" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA29.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA29.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA29.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA30" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA30.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA30.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA30.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA31" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA31.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA31.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA31.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA32" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA32.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA32.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA32.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB29" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB29.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB29.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB29.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB30" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB30.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB30.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB30.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB31" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB31.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB31.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB31.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB32" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB32.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB32.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB32.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','8')">保存</button>
			...
			<form name="form1" id="form-validateA" action="${root}/siteinfo/advanced/dlmForm/save" method="post">
				...
				<!-- 基站A保留1 -->
				<div class="ui-list fn-clear" id="formtabs2_cont8" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						<colgroup>
							<!--注意用colgrounp标签组定义表格的每列宽度不可删除-->
							<col></col>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA33" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA33.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA33.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA33.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA34" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA34.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA34.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA34.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA35" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA35.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA35.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA35.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA36" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA36.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA36.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA36.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB33" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB33.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB33.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB33.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB34" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB34.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB34.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB34.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB35" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB35.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB35.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB35.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB36" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB36.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB36.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB36.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','9')">保存</button>
			...
			<form name="form1" id="form-validateA" action="${root}/siteinfo/advanced/dlmForm/save" method="post">
				...
				<!-- 基站A保留1 -->
				<div class="ui-list fn-clear" id="formtabs2_cont9" style="display: none;">
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						<colgroup>
							<!--注意用colgrounp标签组定义表格的每列宽度不可删除-->
							<col></col>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipA37" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA37.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA37.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA37.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA38" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA38.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA38.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA38.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA39" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA39.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA39.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA39.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipA40" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityA40.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityA40.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityA40.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table id="" class="ui-table-form  table-fix" summary="这是一个1行1列的表格样式模板">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<select name="ownership" id="ownershipB37" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB37.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB37.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB37.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB38" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB38.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB38.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB38.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB39" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB39.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB39.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB39.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
								<th><label class="">Ownership</label>
								</th>
								<td>
									<select name="ownership" id="ownershipB40" class="input-select input-wd20"
										datatype="*" sucmsg=" " nullmsg="请选择所有权!" onchange="changeAttribute('A')">
						                <option value="">请选择</option>
						                <option value="L" <c:if test="${entityB40.ownership=='L' }">selected="selected"</c:if>>本地权限</option>
						                <option value="R" <c:if test="${entityB40.ownership=='R' }">selected="selected"</c:if>>远程权限</option>
						                <option value="C" <c:if test="${entityB40.ownership=='C' }">selected="selected"</c:if>>清除保留</option>
	            					</select>
								</td>
							</tr>
							<tr>
					...
					<table class="ui-table-form  table-fix" >
						<tfoot>
							<tr>
							<td colspan="4">
							<button type="submit" class="btn btn-submit" onclick="setStatus('0','10')">保存</button>
							<button type="submit" class="btn btn-submit" onclick="setStatus('1','10')" style="background-color: #FF7F50">设置</button></td>
							</tr>
						</tfoot>
					</table>
				</div>
				...
				<li title="全部">
					...
					<ul>
						...
						<li title="Data Link Management">
							<a href="${root}/siteinfo/setting/advanced/dlmForm/${siteInfoId}" class="current"> 
								<span class="arrow"></span> 
	...
	<script type="text/javascript">
		$(function() {
			var regfromA = $("#form-validateA").Validform({
				tiptype : 1,
				ignoreHidden : true,
				showAllError : false
			});
			var regfromB = $("#form-validateB").Validform({
				tiptype : 1,
				ignoreHidden : true,
				showAllError : false
			});
		...
		function resetForm() {
			$("#form-validateA").Validform().resetForm();
			$("#form-validateB").Validform().resetForm();
		}
		function setStatus(status, id){
			$("#status"+id).val(status);
		}
	...
	<script type="text/javascript">
		$(function() {
			$("#seqNumberA").val("${entityA.seqNumber}");
			$("#seqNumberB").val("${entityB.seqNumber}");
			
			var tempChannelType = "AB";
			for(var i=1; i<=tempChannelType.length; i++) {
				var channelType = tempChannelType.substring(i-1,i);
				for(var j=1; j<=4; j++) {
					var id = channelType + j;
					if($("#ownership" + id).val()=="" || $("#ownership" + id).val()=="C") {
						$("#startSlot"+id).attr("disabled","disabled");
						$("#startSlot"+id).attr("ignore","ignore");
						$("#slotNumber"+id).attr("disabled","disabled");
						$("#slotNumber"+id).attr("ignore","ignore");
						$("#timeout"+id).attr("disabled","disabled");
						$("#timeout"+id).attr("ignore","ignore");
						$("#increment"+id).attr("disabled","disabled");
						$("#increment"+id).attr("ignore","ignore");
					}
				}
			}
		});
		function changeAttribute(id) {
			var incrementVal = $("#ownership" + id).val();
			if(incrementVal=="C" || incrementVal=="") {
				$("#startSlot"+id).attr("disabled","disabled");
				$("#startSlot"+id).attr("ignore","ignore");
				$("#startSlot"+id).val("");
				$("#slotNumber"+id).attr("disabled","disabled");
				...
				$("#startSlot"+id).removeAttr("disabled");
				$("#startSlot"+id).removeAttr("ignore");
				$("#slotNumber"+id).removeAttr("disabled");
				$("#slotNumber"+id).removeAttr("ignore");
				$("#timeout"+id).removeAttr("disabled");
				$("#timeout"+id).removeAttr("ignore");
				$("#increment"+id).removeAttr("disabled");
				$("#increment"+id).removeAttr("ignore");
			}
		}
		
		//seqNumber的值改变的时候，重新获取实体信息
		function getDlmEntity(channelType) {
			var seqNumber = '';
			var siteInfoId = $("#siteInfoId").val();
			if(channelType=='A') {
				seqNumber = $("#seqNumberA").val();
			} else {
				seqNumber = $("#seqNumberB").val();
			}
			$.ajax({
				type : "POST",
				data : "siteInfoId=" + siteInfoId + "&channelType=" + channelType+"&seqNumber="+seqNumber,
				dataType : "json",
				url : '${root}/siteinfo/advanced/showDlmEntity',
				success : function(data) {
					if(data.entity!=null) {
						$("#id" + channelType).val(data.entity.id);
						$("#startSlot" + channelType).val(data.entity.startSlot);
						$("#increment" + channelType).val(data.entity.increment);
						$("#owership" + channelType).val(data.entity.owership);
						$("#slotNumber" + channelType).val(data.entity.slotNumber);
						$("#timeout" + channelType).val(data.entity.timeout);
						$("#siteInfoId" + channelType).val(data.entity.siteInfoId);
					} else {
						$("#id" + channelType).val("");
						$("#startSlot" + channelType).val("");
						$("#increment" + channelType).val("");
						$("#owership" + channelType).val("L");
						$("#slotNumber" + channelType).val("");
						$("#timeout" + channelType).val("");
					}
				}
			});
		}
