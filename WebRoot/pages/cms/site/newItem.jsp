					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="${root}/cms/site/insertItem" method="post" id="format_form" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="siteName" class="span6 m-wrap" />
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="domain" class="span6 m-wrap" />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">站点路径
										</label>
										<div class="controls">
											<input type="text" name="sitePath" class="span6 m-wrap" />
										</div>
									</div>
