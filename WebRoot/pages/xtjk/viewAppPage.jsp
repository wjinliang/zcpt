					...
					<div class="span8">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<form action="${root}/xtjk/updateApp" method="post"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="userName" id="userName" data-required="1"
												class="span6 m-wrap" value="${appInfo.userName}" <c:if test="${mode=='view'}"> readonly="readonly" </c:if>/>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="passWord" id="passWord" data-required="1"
												class="span6 m-wrap" value="${appInfo.passWord}" <c:if test="${mode=='view'}"> readonly="readonly" </c:if>/>
