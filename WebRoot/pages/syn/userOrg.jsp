...
<div class="row-fluid" >
									...
									<tbody>
										<c:forEach items="${orgList}" var="org" varStatus="status">
											...
											<c:if test="${empty org.type}">
												...
												<td style="vertical-align: middle;"><a href="${root}/syn/gotoSynOrgUser?appId=${appId }&orgid=${org.id}">查看</></td>
												<td style="vertical-align: middle;"><a href="${root}/syn/gotoSynUser?appId=${appId }&orgId=${org.id}">查看</></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
	...
	function gopage(thispage){
		...
		window.location.href="${root}/syn/gotoSynOrgUser?appId=${appId}&thispage="+thispage+"&orgid="+orgid+"&tj="+tj;
	}
	function nextpage(){
