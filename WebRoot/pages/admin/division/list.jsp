...
<!-- END HEAD -->
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="<%=basePath%>division/list">区划管理</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span6">
						<div class="portlet box green" >
							<div class="portlet-title">
								...
								<div class="actions">
									<a href="javascript:refreshorgtree()" class="btn">刷新</a>
	...
	var zNodes =${orgStr};
		jQuery(document).ready(function() {
			$.fn.zTree.init($("#treeOrg"), settingMenu, zNodes);
	...
	function addMenu() {
		...
		if (zTree.getSelectedNodes()[0]) {
			...
			opendg('<%=basePath%>division/form/new?orgid=' + orgid, 740,
					567);
		} else {
			alert("请选中父区划节点");
		}
	...
	function addTopMenu() {
		hideRMenu();
		opendg('<%=basePath%>division/form/new', 740, 567);
	}
	function editMenu() {
		hideRMenu();
		if (zTree.getSelectedNodes()[0]) {
