		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							表单 <small>新增/修改菜单组</small>
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="${root}/mainpage">主页</a>
								<i class="icon-angle-right"></i></li>
							<li><a href="${root}/menugroup/list">菜单组管理</a> <i
					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<form action="${root}/menugroup/save" method="post" id="format_form" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">菜单组名<span
											class="required">*</span>
										</label>

										<div class="controls">

											<input type="text" name="name" value="${menugroup.name}" data-required="1"
												class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="seq" value="${menugroup.seq}" data-required="1"
												class="span6 m-wrap" />
