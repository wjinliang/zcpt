	...
	<!-- END HEADER -->
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							角色授权 <small>选择角色菜单菜单</small>
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="${root}/mainpage">主页</a>
								<i class="icon-angle-right"></i></li>
							<li><a href="${root}/menugroup/list">角色管理</a> <i
							...
							<div class="portlet-body form">
								...
								<div class="form-horizontal form-view">
									...
									<div class="form-actions">
										<button type="button" onclick="setMenus('${menugroup.code}')"
											class="btn blue">
		...
		<script type="text/javascript">
			...
			function setMenus() {
				...
				$.ajax({
					url : "${root}/menugroup/setmenus",
					type : "POST",
					data : "menugroupid=${menugroupid}&menuids=" + menuids,
					success : function(data) {
						if (data == "ok") {
							$("#success").fadeIn(1500, function() {
								window.location.href = "${root}/menugroup/list";
							});
						}
					}
				});
