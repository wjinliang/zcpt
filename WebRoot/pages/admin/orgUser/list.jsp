...
<!-- END HEAD -->
									...
									<tbody>
										<c:forEach items="${orgList}" var="org" varStatus="status">
											<tr >
												...
												<td style="vertical-align: middle;"><a href="${root}/orgAndUser/listUsers?orgid=${org.id}">查看</></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
	...
	<script>
		...
		function gopage(thispage){
			var tj=$("#tjcx").val();
			var orgid=document.getElementById('divisionid').value;
			window.location.href="${root}/orgAndUser/listOrgs?thispage="+thispage+"&divisionid="+orgid+"&tj="+tj;
		}
		function nextpage(){
		...
		function newItem(){
			...
			window.location.href="${root}/orgAndUser/form/new?divisionid="+divisionid+"&flag=0";
		}
