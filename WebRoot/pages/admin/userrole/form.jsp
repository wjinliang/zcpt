					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<form action="${root}/userrole/save" method="post" id="format_form" class="form-horizontal">
									<input type="hidden" name="code" value="${userrole.code}" />
									...
									<div class="control-group">
										...
										<label class="control-label">角色名<span
											class="required">*</span>
										</label>

										<div class="controls">

											<input type="text" name="name" value="${userrole.name}" data-required="1"
												class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<label class="control-label">主页路径<span
											class="required">*</span>
										</label>

										<div class="controls">

											<input type="text" name="homePage" value="${userrole.homePage}" data-required="1"
												class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<c:if test="${userrole.enabled}">  checked="checked" </c:if>
											/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="seq" value="${userrole.seq}" data-required="1"
												class="span6 m-wrap" />
