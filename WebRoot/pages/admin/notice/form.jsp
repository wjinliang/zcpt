...
<!-- END HEAD -->
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							公告表单 <small>新增/修改公告</small>
						</h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="${root}/mainpage">主页</a>
								<i class="icon-angle-right"></i></li>
							<li><a href="${root}/notice/list">公告信息</a> <i
					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<form action="${root}/notice/save" method="post" id="format_form" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="noticeTitle" value="${notice.noticeTitle}" data-required="1"
												class="span4 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="noticeOriginal" value="${notice.noticeOriginal}" 
												class="span4 m-wrap" />
									...
									<div class="control-group">
										...
										<label class="control-label">发布日期
										</label>

										<div class="controls">

											<input type="text" name="noticeDate" id="noticeDate" readonly="readonly" value="${notice.noticeDate}" 
												class="span4 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea id="editor_id" name="noticeContent" class="span10 m-wrap" style="height:400px;">
	...
	<script charset="utf-8" src="<%=basePath%>themes/kindeditor-4.1.10/kindeditor.js"></script>
	<script charset="utf-8" src="<%=basePath%>themes/kindeditor-4.1.10/lang/zh_CN.js"></script>
