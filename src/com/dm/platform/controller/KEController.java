...
public class KEController {
	...
	public void file_upload(
			...
			throws Exception {
		try {
			String savePath = ReadProperties.getInstance().getProperties(
					"uploadPath")
					+ "/"
					+ UserAccountUtil.getInstance().getCurrentUserId()
					+ "/";
			// 文件保存目录URL
			String saveUrl = ReadProperties.getInstance().getProperties(
					"uploadUrl")
					+ "/"
					+ UserAccountUtil.getInstance().getCurrentUserId()
					+ "/";
	...
	public void file_manager(HttpServletRequest request,
		...
		String rootPath = ReadProperties.getInstance().getProperties(
				"uploadPath")
				+ "/" + UserAccountUtil.getInstance().getCurrentUserId() + "/";
		// 文件保存目录URL
		String rootUrl = ReadProperties.getInstance()
				.getProperties("uploadUrl")
				+ "/"
				+ UserAccountUtil.getInstance().getCurrentUserId() + "/";
		// 图片扩展名
